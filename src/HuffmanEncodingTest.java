...
public class HuffmanEncodingTest {
	...
	@Test
	public void testEmptyFileEncode() {
		HuffmanEncoding txt = new HuffmanEncoding();
		txt.encode("sample_files/blank.txt", "completeBlank.txt");
		assertEquals(txt.getByteCodeTable().size(), 1);	
	}
	...
	@Test
	public void testEmptyFileDecode() {
		HuffmanEncoding txt = new HuffmanEncoding();
		txt.encode("sample_files/blank.txt", "completeBlank2.txt");
		txt.decode("completeBlank2.txt", "decodedBlank.txt");
		assertEquals(txt.getByteCodeTable().size(), 0);	
	}
}
